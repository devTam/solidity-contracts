...
contract ICOTAM is MyERC20Token {
    address public admin;

    // Recipient of ICO investments
    address payable public recipient;

    //  price of one token 0.01 ETH
    uint256 public price = 10000000000000000;

    // soft cap of 500 ETH -> shows project is successful
    uint256 public softCap = 500000000000000000000;

    // hard cap of 1000 ETH -> shows project is done
    uint256 public hardCap = 1000000000000000000000;

    // amount of tokens sold
    uint256 public tokensSold = 0;

    // maximum amount of tokens that can be sold - 10 ETH
    uint256 public maxTokens = 10000000000000000000;

    // minimum amount of tokens that can be sold - 0.01 ETH
    uint256 public minTokens = 10000000000000000;
    ...
    function buyTokens() public payable returns (bool success) {
        ...
        require(msg.value <= softCap);
        require(tokensSold < maxTokens);
        require(tokensSold >= minTokens);
